...
㉔ **`networktest.list`** 源采用 [v2fly/domain-list-community/test-ipv6](https://github.com/v2fly/domain-list-community/blob/master/data/test-ipv6)（删除了带有 `@cn` 的域名）、[v2fly/domain-list-community/category-speedtest](https://github.com/v2fly/domain-list-community/blob/master/data/category-speedtest)（删除了带有 `@cn` 的域名）、[v2fly/domain-list-community/category-ip-geo-detect](https://github.com/v2fly/domain-list-community/blob/master/data/category-ip-geo-detect)（删除了带有 `@cn` 的域名）和 [blackmatrix7/ios_rule_script/Speedtest](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Clash/Speedtest) 组合  
